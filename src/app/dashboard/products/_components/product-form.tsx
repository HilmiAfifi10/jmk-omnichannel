  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      ...
      if (result.success) {
        ...
        toast.success(
          isEditing ? "Produk berhasil diupdate" : "Produk berhasil dibuat"
        );
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Informasi dasar tentang produk Anda</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Kategori dan status produk</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Hanya produk dengan status &quot;Aktif&quot; yang tampil di
                katalog
              </p>
            </div>
          </div>
